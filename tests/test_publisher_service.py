...
def test_process_rss_flow_success(clients):
    ...
    vk.publish_post.return_value = "https://vk.com/wall1_1"
    ...
    sheets.update_rss_row.assert_called_once_with(row, "https://telegra.ph/page", "https://vk.com/wall1_1", "https://t.me/channel/1")
...
def test_process_rss_flow_uses_existing_telegraph_link(clients):
    ...
    sheets.fetch_rss_ready_rows.return_value = [row]
    vk.publish_post.return_value = "https://vk.com/wall1_2"
    telegram.send_post.return_value = "https://t.me/channel/2"

    service.process_rss_flow()

    telegraph.create_page.assert_not_called()
    sheets.update_rss_row.assert_called_once_with(row, "https://telegra.ph/existing", "https://vk.com/wall1_2", "https://t.me/channel/2")
...
def test_process_vk_flow_success(clients):
    ...
    vk.publish_post.return_value = "https://vk.com/wall1_3"

    service.process_vk_flow()

    vk.publish_post.assert_called_once()
    sheets.mark_vk_published.assert_called_once_with(row, "https://vk.com/wall1_3")
